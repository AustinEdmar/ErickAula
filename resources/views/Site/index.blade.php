...
<section class="banner" role="banner" id="banner">
  <header id="header">
    <div class="header-content clearfix"> <span class="logo"><a href="index.html">{{config('app.name')}}</a></span>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
		  <li><a href="#banner">Home</a></li>
          <li><a href="#intro">Top 10</a></li>
          <li><a href="#services">Programas da Radio</a></li>
          <li><a href="#Playlist">Playlist</a></li>
		  <li><a href="#package">Albums de Fotos</a></li>
          <li><a href="#gallery">Eventos</a></li>
  ...
  <div class="container">
    <div class="col-md-10">
      <div class="banner-text text-center">
        ...
        <p>Ouca a nossa Radio</p>
		<div><strong>99.9 FM</strong></div>
		</div>
      <!-- banner text --> 
    </div>
  </div>
...
<section id="intro" class="section intro">
  <div class="container">
    <div class="col-md-8 col-md-offset-2 text-center">
      <h3>Top 10 da radio</h3>
      <p>Confira as melhores</p> 
...
<section id="gallery" class="gallery section">
  <div class="container-fluid">
    ...
    <div class="row no-gutter">
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/01.jpg" class="work-box"> <img src="/assets/images/portfolio/01.jpg" alt="">
        <div class="overlay">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/02.jpg" class="work-box"> <img src="/assets/images/portfolio/02.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/03.jpg" class="work-box"> <img src="/assets/images/portfolio/03.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/04.jpg" class="work-box"> <img src="/assets/images/portfolio/04.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption"> 
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/05.jpg" class="work-box"> <img src="/assets/images/portfolio/05.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/06.jpg" class="work-box"> <img src="/assets/images/portfolio/06.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/07.jpg" class="work-box"> <img src="/assets/images/portfolio/07.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
            <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 work"> <a href="/assets/images/portfolio/08.jpg" class="work-box"> <img src="/assets/images/portfolio/08.jpg" alt="">
        <div class="overlay">
          <div class="overlay-caption">
             <p><span class="icon icon-magnifying-glass"></span></p>
          </div>
...
<section id="tours" class="section teams"> 
	<div class="container">
	    <div class="section-header">
                <h2 class="wow fadeInDown animated">Shows</h2>
                <p class="wow fadeInDown animated">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p>
            </div>
		<div class="row">
			<div class="col-md-6">
...
<section id="contact" class="section">
  <div class="container">
      <div class="section-header">
                <h2 class="wow fadeInDown animated">Contacte-nos</h2>
                <p class="wow fadeInDown animated">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p>
            </div>
    <div class="row">
    ...
    <div class="col-xs-12">    
    	<iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.uk/maps?f=q&source=s_q&hl=en&geocode=&q=15+Springfield+Way,+Hythe,+CT21+5SH&aq=t&sll=52.8382,-2.327815&sspn=8.047465,13.666992&ie=UTF8&hq=&hnear=15+Springfield+Way,+Hythe+CT21+5SH,+United+Kingdom&t=m&z=14&ll=51.077429,1.121722&output=embed"></iframe> 
          ...
          <div id="map-overlay" class="col-xs-5 col-xs-offset-6" style="">
    		<h2 style="margin-top:0;color:#fff;">Contacte-nos</h2>
